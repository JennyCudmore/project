...
#Read in all individual tables into one (iterates through paths, adds each file to a list, combines the list into one)
...
#Write out the combined files to a csv
individual %>%
  readr::write_csv(
...
#Can add new 2 columns, stemLat and stemLon by extracting locations from get_stem_locaiton
